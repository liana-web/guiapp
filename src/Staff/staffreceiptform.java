 ...
 */
public class staffreceiptform extends javax.swing.JFrame {

    /**
     * Creates new form staffreceiptform
     */    
    public staffreceiptform(String receiptText) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(staffreceiptform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new staffreceiptform("Test Receipt").setVisible(true);
            }
        });
    }
